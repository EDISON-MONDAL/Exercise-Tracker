...
users[index]['count']++
  ...
  const exercise = { username: users[index]['username'], description: lastLog['description'], duration: parseInt(lastLog['duration']), date: lastLog['date'].toDateString() , _id: users[index]['_id'] }
  /*
